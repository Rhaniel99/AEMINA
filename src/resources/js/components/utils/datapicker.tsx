...
// import { CalendarDays } from '@radix-ui/react-icons';
import {
  endOfHour,
  endOfMinute,
  format,
        ...
        <div className="flex items-center justify-between">
          <div className="text-md font-bold ms-2 flex items-center cursor-pointer">
            <div>
              ...
              {format(month, 'MMMM', { locale: ptBR }).toUpperCase()}
...
function MonthYearPicker({
  ...
  const months = useMemo(() => {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      months.push({ value: i, label: format(new Date(0, i), 'MMM', { locale: ptBR }), disabled });
    }
    return months;
  }, [value]);
